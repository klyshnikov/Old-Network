...
class NeuralNetworkFeedForward():
    ...
    def train(self, data, all_y_trues):
            ...
            for x, y_trues in zip(data, all_y_trues):
                ...
                for one_neuron_output in y_trues:
                    ...
                    for i3 in self.list_hid_out_weights:
                        for i4 in i3:
                            derivative_i4 = self.learn_rate * p_L_p_ypred * y_notall_pred[
                                number_i3] * self.deriv_sigmoid(y_pred_sum[number_i3]) #если что в скрытом нейроне менять i3 -> i4
        ...
        print(self.list_inp_hid_weights, self.list_hid_out_weights)


# keki = NeuralNetworkFeedForward(3, 3, 1)
# keki.list_biases = [0.2, 0.1, -0.4, 0.1, -0.1, 0.9, 0.1]
# keki.set_normal_values()
# data = np.array(
...
#
# keki.train(data, all_y_trues)
#
# print(keki.list_inp_hid_weights, keki.list_hid_out_weights)
#
# print(keki.feedforward_output([5, 0, 4]))
# print("True: 1")
# print(keki.feedforward_output([1, 4, -8]))
# print("True: 0")
# print(keki.feedforward_output([9, 8, -4]))
# print("True: 1")
# print(keki.feedforward_output([4, 4, 1]))
# print("True: 1")
# print(keki.feedforward_output([3, -9, 2]))
# print("True: 0")
# print(keki.feedforward_output([44, 9, -2]))
# print("True: 1")
# print(keki.feedforward_output([90, 9, 2]))
#print("True: 1")
#print(keki.feedforward_output([100, -9, 2]))
#print("True: 0")

#plt.plot(keki.x_means, keki.y_means)
#plt.show()

rrr = NeuralNetworkFeedForward(2, 2, 1)
rrr.list_biases = [0, 0, 0, 0, 0, 0, 0]
rrr.set_normal_values()
data = np.array([[40,  11],
 [60,  23],
 [40,  27],
 [20,  11],
...
# rrr.list_inp_hid_weights = [[1, 0], [0, 1]]
# rrr. list_hid_out_weights = [[1, 1]]
#rrr.train(data, all_y_trues)
rrr.list_inp_hid_weights = np.array([[0.800024785817727, -2.6359497300326415], [0.800024785817727, -2.6359497300326415]])
rrr.list_hid_out_weights = np.array([[-2.998268278590814, -2.5167838555772466]])

k = 0
for i in data:
    print("=======")
    print(rrr.feedforward_output(i))
    print("True:", all_y_trues[k][0])
    k += 1
print("+++++++++++++++++++")
print(rrr.feedforward_output([20, 15]))
print('True 0')
print(rrr.feedforward_output([40, 24]))
print('True 1')
print(rrr.feedforward_output([60, 20]))
print('True 1')
print(rrr.feedforward_output([60, 30]))
print('True 1')
print(rrr.feedforward_output([40, 11]))
print('True 0')
print(rrr.feedforward_output([20, 12]))
print('True 0')

def predcit(a):
    a = rrr.feedforward_output(a)
